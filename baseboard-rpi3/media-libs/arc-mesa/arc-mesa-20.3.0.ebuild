...
CROS_WORKON_COMMIT="08169ff176b2fdbaf3b9b497a6e45aef4b0bfe43"
...
VIDEO_CARDS="${INTEL_CARDS} ${RADEON_CARDS} llvmpipe mach64 mga nouveau powervr r128 savage sis vmware tdfx via freedreno virgl vc4 v3d kmsro"
...
src_prepare() {
  ...
  epatch ${FILESDIR}/fix-v3d-screen-disorder-issue.patch
...
multilib_src_configure() {
    ...
    gallium_enable video_cards_kmsro kmsro
	fi
