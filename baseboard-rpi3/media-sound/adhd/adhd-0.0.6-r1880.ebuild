...
EAPI=4
CROS_WORKON_COMMIT="0fe4f67e016b4474ca96594c261c91ff27e680e5"
CROS_WORKON_TREE="fd718f459eabd8f704201184abb24baa07bf3fff"
...
src_prepare() {
  ...
  epatch ${FILESDIR}/fix_default_card.patch
	cd cras
	eautoreconf
}
